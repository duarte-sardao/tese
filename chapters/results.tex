...
\begin{table}[t]
    ...
    \midrule
    Point (CM) Manual        & 0 & 3 & Assert \\
    Point (CM) ChatGPT       & 0 & 4 & Assert \\
    Fabricated (OAC) Manual  & 1 & 2 & Assert/Other \\
    Fabricated (OAC) ChatGPT & 2 & 1 & Assert \\
    Fabricated (RO) Manual   & 0 & 15 & Assert/Other \\
    Fabricated (RO) ChatGPT  & 0 & 22 & Assert/Other \\
    Cart (CM) Manual         & 0 & 6 & Assert/Constructor \\
    Cart (CM) ChatGPT        & 0 & 68 & Constructor/Other \\
    Cart (PF) Manual         & 0 & 8 & Assert/Constructor/Branch \\
    Cart (PF) ChatGPT        & 0 & 36 & Assert/Constructor/Branch \\
    Cart (PM) Manual         & 0 & 5 & Assert/Other \\
    Cart (PM) ChatGPT        & 1 & 3 & Assert/Other \\
    \midrule
    \end{tabular}
