...
\begin{table}[t]
    ...
    Fabricated (RO)  &  & Yes \\
    Fabricated (OAC) &  & Yes \\
    Cart (CM)        & Non-Compiling &  \\
    Cart (PF)        & Non-Compiling &  \\
    Cart (PM)        & Non-Compiling &  \\
    Antlr (PF)       & Non-Compiling &  \\
    OkHttp (PM)      & Non-Compiling &  \\
    Retrofit (PM/CM) & Non-Compiling &  \\
    %\midrule
    \bottomrule
    \end{tabular}
...
money)
--prompts with only method signatures and naturally worse at CM type conflicts