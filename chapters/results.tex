...
\begin{itemize}
  ...
  \item \textbf{Identification of the origins of conflict falls squarely in the middle of our given range}\todo{Can we say it differently? E.g., On average, it identifies the origin of the conflict.} ($D=1.5$).  When we exclude 0 value results, the average is 2.77\todo{2.7 ou 2.8?} instead. This indicates to us in nearly half the cases, the model failed to produce any description, but when it did, it was generally very accurate.
