...
The purpose of this chapter is to introduce the motivation for the work, briefly describe the problem at hand and outline the work that will be developed, as well as the structure of the thesis.\todo{This paragraph sounds like PDIS.  Revisit it as there are a few other bits in this chapter.}
...
\begin{itemize}
    ...
    \todo{Provide a brief answer to this RQ.}
